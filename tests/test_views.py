...
class IndexViewTest(TestCase):
    ...
    def test_view_login_with_incorrect_username(self):
        ...
        self.assertTemplateUsed(response, 'home/index.html')
        self.assertEqual(
            response.context['login_error'], 'Invalid Username or Password')
    ...
    def test_view_signup_with_existing_user(self):
        ...
        self.assertTemplateUsed(response, 'home/index.html')
        self.assertEqual(
            response.context['signup_error'], 'Account with entered username already exists')
    ...
    def test_view_signup_with_mismatching_password(self):
        ...
        self.assertTemplateUsed(response, 'home/index.html')
        self.assertEqual(
            response.context['signup_error'], "Passwords don't match")
...
class DashboardViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        test_user3 = User.objects.create_user(
            username='testuser3', password='HGfdgvF677FYV')
    ...
    def setUp(self):
        ...
        self.rooms_obj1 = Rooms.objects.create(
            rooms=7, start_date=date.today())
        ...
        self.time_slot1 = TimeSlot.objects.create(
            start_time=start_time1, end_time=end_time1, start_date=date.today())
        ...
        self.time_slot2 = TimeSlot.objects.create(
            start_time=start_time2, end_time=end_time2, start_date=date.today())
    ...
    def test_correct_data_loaded_in_context_with_bookings(self):
        ...
        booking1 = Booking.objects.create(
            customer=customer, date=booking_date, room=room, time_slot=time_slot, room_manager=room_manager)

        response = self.client.get(reverse('dashboard'))

        self.assertEqual(response.context['user_bookings'].count(), 1)
        self.assertEqual(
            response.context['user_bookings'].first().customer.username, 'testuser2')
    ...
    def test_view_allowance_update_feature_with_invalid_data(self):
        ...
        self.assertTemplateUsed(response, 'home/dashboard.html')
        self.assertEqual(
            response.context['allowance_error'], 'Please enter a valid Pre-Booking Allowance!')
    ...
    def test_view_rooms_update_feature_with_invalid_data(self):
        ...
        self.assertTemplateUsed(response, 'home/dashboard.html')
        self.assertEqual(
            response.context['rooms_error'], 'Please enter valid Number of Rooms!')
    ...
    def test_view_time_slots_update_feature_with_invalid_data(self):
        ...
        self.assertTemplateUsed(response, 'home/dashboard.html')
        self.assertEqual(
            response.context['time_slot_error'], 'Please select a valid time slot!')
